...
const DEFAULT_PROMOS: PromoItem[] = [
  ...
  },
  {
    id: 'bundle-deal',
    type: 'cta',
    title: 'Beli 2, Hemat 30%',
    description: 'Borong lebih banyak, hemat lebih besar. Berlaku untuk semua produk pilihan.',
    badge: 'Bundle Deal',
    icon: 'star',
  ...
  },
  {
    id: 'cashback-ewallet',
    type: 'visual',
    title: 'Cashback 15% Pakai GoPay / OVO',
    description: 'Bayar dengan e-wallet favoritmu dan langsung dapat cashback hingga Rp 25.000.',
    badge: 'Cashback',
    icon: 'shield',
    iconClass: 'text-emerald-600 bg-emerald-50',
    highlights: ['Min. transaksi Rp 100.000', 'Maks. cashback Rp 25.000', 'Berlaku s/d 31 Juli 2026'],
  },
];
